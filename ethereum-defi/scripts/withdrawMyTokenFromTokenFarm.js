...
module.exports = async function (callback) {
	...
	console.log("\n*** Farm Token ***")
	balanceFarmTokenBeforeAccount0 = await farmToken.balanceOf(accounts[0])
	balanceFarmTokenBeforeFarmToken = await farmToken.balanceOf(farmToken.address)
	console.log("Balance FarmToken Before accounts[0] " + web3.utils.fromWei(balanceFarmTokenBeforeAccount0.toString()))
